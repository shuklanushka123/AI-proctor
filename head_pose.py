        ...
        if results.multi_face_landmarks:
            for face_landmarks in results.multi_face_landmarks:
                ...
                if y < -10:
                    ...
                    text = "Looking Down"
                    print("Warning!! You are looking down. This could lead to malpractice")
                else:
                ...
                cv2.line(image, p1, p2, (29,255, 0), 2)

                # Add the text on the image
                cv2.putText(image, text, (20, 20), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 106, 0), 2)
        
        cv2.imshow('Head Pose Estimation for Proctoring', image)
